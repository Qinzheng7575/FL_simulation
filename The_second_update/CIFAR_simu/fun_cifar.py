...
def set_method(args: dict, quality: str):
    if quality == 'perfect':
        ...
        args['recv_threshold'] = 1.547
        args['wait_threshold'] = 1.043

    elif quality == 'bad':
        args['recv_threshold'] = 1.21
        args['wait_threshold'] = 0.98
    else:
        exit()
    return(args)
...
def BS_receive(UEs: list, train_args, grading):
    ...
    for ue in UEs:
        ...
        data_size = calculte_size(param, 3)
